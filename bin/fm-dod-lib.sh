...
Push your branch, open a PR with \`gh-axi\`, and paste that final Stage 1 verdict into the PR body under a \`## Code Review (Stage 1)\` heading, then append \`done: PR {url}\` to the status file and stop.
