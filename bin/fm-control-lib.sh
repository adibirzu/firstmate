...
fm_control_harness_supported() {  # <harness>
  case "${1-}" in
    claude|codex|opencode|pi|pi-signed|grok|kimi|cursor|gemini|muse|cline|copilot|agy|rovo) return 0 ;;
  esac
  return 1
}
...
fm_control_interrupt_key() {  # <harness>
  case "${1-}" in
    claude|codex|opencode|pi|pi-signed|kimi|cursor|gemini|muse|cline|agy|rovo) printf 'Escape' ;;
...
fm_control_interrupt_repeat() {  # <harness>
  case "${1-}" in
    opencode) printf '2' ;;
    claude|codex|pi|pi-signed|grok|kimi|cursor|gemini|muse|cline|copilot|agy|rovo) printf '1' ;;
    *) return 1 ;;
  esac
}
...
fm_control_interrupt_clear_key() {  # <harness>
  case "${1-}" in
    muse) printf 'C-u' ;;
    claude|codex|opencode|pi|pi-signed|grok|kimi|cursor|gemini|cline|copilot|agy|rovo) ;;
    *) return 1 ;;
  esac
}
...
fm_control_interrupt_ack_source() {  # <harness>
  case "${1-}" in
    ...
    claude|codex|opencode|pi|pi-signed|grok|kimi|cursor|gemini|cline|copilot|agy|rovo) printf 'none' ;;
    *) return 1 ;;
  esac
}
...
fm_control_exit_key() {  # <harness>
  case "${1-}" in
    cline) printf 'C-c' ;;
    claude|codex|opencode|pi|pi-signed|grok|kimi|cursor|gemini|muse|copilot|agy|rovo) ;;
    *) return 1 ;;
  esac
}
