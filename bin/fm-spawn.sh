...
#   /updatefirstmate, restart). A bare adapter name (claude|codex|opencode|pi|pi-signed|grok|kimi|cline|cursor-agent|copilot|muse)
...
case "$KIND:$HARNESS" in
  secondmate:muse) secondmate_harness_unsupported muse ;;
esac
