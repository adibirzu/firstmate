...
description: >-
  ...
  Contains verified facts for claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, cursor-agent, gemini, muse, cline, copilot, agy, rovo, and omp.
...
```json harness-adapter-routing-v1
{
  ...
  "harnesses": {
    ...
    "cursor-agent": "references/harness/cursor-agent.md",
