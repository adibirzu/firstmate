...
config/herdr-session-host  optional short host token for the fm-<host>-<project>-<task-id> Herdr task-tab display name, falling back to the machine's short hostname; LOCAL, gitignored, deliberately not inherited; see docs/herdr-backend.md "Session naming"
