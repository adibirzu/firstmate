...
state/               runtime records and signals; gitignored
  ...
  remote-dev-sessions/<station>.session  durable per-station remote development session continuity record; written only by bin/fm-remote-dev-session.sh and surfaced by bin/fm-fleet-snapshot.sh and bin/fm-fleet-view.sh; docs/remote-dev-sessions.md owns the schema
