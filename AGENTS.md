...
state/               runtime records and signals; gitignored
  ...
  <id>.pr-poll-merge-notified  canonical PR identity of the last merge outcome delivered for this task; bin/fm-pr-lib.sh owns the marker format and identity mechanics, bin/fm-merge-outcome-lib.sh owns locked publication, duplicate suppression, and replacement, and a poll re-armed for that same merge is absorbed instead of waking the captain twice; removed by teardown
