...
agy is verified for crewmate launches only, and a `--secondmate` spawn refuses it; [`docs/verification/agy-adapter.md`](verification/agy-adapter.md) owns that evidence.
