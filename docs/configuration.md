  ...
  "rules": [
    {
      ...
      "use": [
        { "harness": "<adapter>", "provider": "<claude|codex|grok|cursor|agy, optional>", "model": "<optional model>", "effort": "<low|medium|high|xhigh|max|ultra, optional>", "quotaWindow": "<optional quota-axi windows[].id>" }
      ],
