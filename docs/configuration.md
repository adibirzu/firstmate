...
Picking also releases the live branch so the next wake reopens the same persistent branch conversation under the new model and effort without waiting for a session replacement.
