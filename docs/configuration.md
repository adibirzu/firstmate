...
claude, codex, opencode, pi, pi-signed, grok, kimi, and agy are empirically verified for crewmate and secondmate launches; agy is verified for crewmate launches (not secondmate); [README requirements](../README.md#requirements) own the set supported for the primary session.
