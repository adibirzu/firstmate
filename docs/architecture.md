...
Static and explicit dispatch keep spawn launch compatible across claude, codex, grok, pi, opencode, kimi, cline, and cursor-agent, while automatic subscription arrays exclude Kimi and preserve the selected profile for later audit.
