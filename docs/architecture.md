...
Static and explicit dispatch keep spawn launch compatible across claude, codex, grok, pi, opencode, and kimi; [`configuration.md`](configuration.md#crew-dispatch-profiles-configcrew-dispatchjson) owns dispatch-profile eligibility and selected-profile audit.
